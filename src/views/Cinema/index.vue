<template>
    <div>
        <Header title="卖座影院" varity="cinema"></Header>
        <div id="content">
            <div class="header-bar">
            <dropdown-menu>
            <dropdown-item :title="city" v-model="city" ref="cityItem"> 

                     <grid :gutter="15" :column-num="4" :clickable="true" ref="gridEl" >
...
//最近去过
        ...
        const getCinema=async()=>{
            ...
            store.commit("setCinema",info.cinemaList)//写入仓库
            info.showCinemaList=result.cinemas 
            info.city="全城"         
            info.cinemaList.map((item)=>{//把区域筛选出来
            ...
            if(index==0){
                info.city="全城"
                 info.showCinemaList=info.cinemaList
                  ...
                  info.city=info.districtarr[index]                   
                info.cinemaList.map(item=>{               
