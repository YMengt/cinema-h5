    ...
    <div class="cinemeDetail">
        ...
        <div class="schedules-content">
            <div class="schedules-tab">
                <tabs v-model:active="active" :tabindex="tabindex" swipeable @change="changeTab">
                    <tab   title='今天'>
...
export default {
    ...
    components:{MovieDetailHeader,Sticky,Tab, Tabs,CinemaDetailItem,Icon,MySwiperVue,Swipe, SwipeItem},
        ...
        const getMyCinemaMessage=async()=>{
            ...
            let result3=await api.cinemaInfo.getTimeByCinemaId({filmId:info.detailMovieList[0].filmId,cinemaId:info.cinemaList.cinemaId,date:dateTime}) 
        ...
        function getTime(x){
            ...
            let da=d.getDate()+x
			let str=d.getFullYear()+"-"+month+"-"+da+" 24:00:00"
...
const changeTab=async()=>{
    ...
    await api.cinemaInfo.getTimeByCinemaId({filmId:info.detailMovieList[0].filmId,cinemaId:info.cinemaList.cinemaId,date:dateTime}) 
    info.schedulesList=result3.schedules
}
        return {
            onChange,
