<template>
    <div>
        ...
        <div id="content">
            ...
            <!-- <CinemaDetail :showCinemaList="showCinemaList" :isShowAppOrder="isShowAppOrder"></CinemaDetail> -->
		</div>
...
// import CinemaDetail from "../../components/Comp/CinemaDetail.vue";
    export default {
         name:'Cinema',
        components:{Header,TabBar, DropdownMenu, DropdownItem,Cell,Grid, GridItem,CinemaDetail},
    setup () {
        let info=reactive({
            cinemaList:[],
            showCinemaList:[],
