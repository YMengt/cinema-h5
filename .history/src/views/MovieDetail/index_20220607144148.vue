		...
		<div class="container">
			...
			<div class="movie-photo">
				<div class="photo-bar">
					...
					<span class="photo-all">全部({{FileList.photos.length}})<span class="iconfont icon-jiantouyou"></span></span>
				</div>
			...
			<!-- <div class="pay-ticket"> -->
				<Button type="danger" color="#ff5f16" size="large" block>单色按钮</Button>
			<!-- </div> -->
		</div>
	</div>
</template>
