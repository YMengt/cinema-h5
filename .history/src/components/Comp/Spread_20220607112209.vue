...
<div class="m-content overflow-line" id="J_description">{{mes2}}</div>
    <p type="button" class="btn-more" v-if="isShowMore" id="J_btnmore" @click="showmoreDesc($event)">查看更多<span class="iconfont icon-xiangxiajiantou"></span></p>
    </div>
</template>
...
export default {
    ...
    setup (props) {
      ...
      function   showmoreDesc(e) {
        ...
        el.innerHTML = !info.isDescStatus ? '查看更多<span class="iconfont icon-xiangxiajiantou"></span>' : '收起';
