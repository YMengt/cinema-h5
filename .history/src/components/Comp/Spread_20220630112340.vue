...
<div class="m-content overflow-line" id="J_description">{{ mes2}}</div>
      ...
      <p type="button" class="btn-more" v-if="mes2.length>75" id="J_btnmore" @click="showmoreDesc($event)"><span class="iconfont icon-xiangxiajiantou"></span>
      </p>
    ...
    setup (props) {
        ...
        console.log(props.mes2)
         info.introduce=props.mes2;
          if(props.mes2>75){//文字超过字数，开启展示更过
