<template>
    <div>
		<movie-detail-header-vue style="position: fixed;overflow: auto;" title="当前城市" :isShowBack="true"></movie-detail-header-vue >
        <div class="city_body">
				<!-- <div class="city_list">
					<div class="city_hot">
						<h2>热门城市</h2>
				...
				<index-bar sticky=false :sticky-offset-top="44">
					...
					<index-anchor :index="item.letter"  />				
						<cell  v-for="(item2,index2) in item.value" :key="index2" :title="item2.name"></cell>
					</div>
				</index-bar>
