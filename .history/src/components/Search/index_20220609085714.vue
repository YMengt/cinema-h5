...
<MovieDetailHeaderVue :isShowBack="true" title="搜索"></MovieDetailHeaderVue>
...
import { useStore } from 'vuex'
    export default {
		...
		setup(){
			...
			if(route.query.type=="cinema"){

				console.log(store.state.nowPlayingMovie)
